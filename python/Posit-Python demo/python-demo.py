...
# Create a python environment: uv venv (In the Terminal)

import sys
import subprocess

# This targets the uv binary to install the packages into your current environment
subprocess.check_call(["uv", "pip", "install", "--python", sys.executable, "plotnine", "polars"])

import plotnine as p9
import polars as pl

species = pl.read_csv("./georgia-aquarium-species.csv")
species
